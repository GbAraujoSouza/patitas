...
import { CheckMark, InputCheckbox, LogoCadastro, StyledCheckboxLabel } from './style';
  ...
  return (
    <FormPageContainer>
      ...
      <StyledForm action="">
        <InputContainer>
          <img
            src="/src/assets/icons/icone-nome.svg"
            alt="icone nome"
            width={24}
            height={24}
          />
        ...
        <InputContainer>
          <img src="/src/assets/icons/icone-cpf.svg" alt="icone cpf" />
          <input type="number" id="cpf" required placeholder="CPF ..." />
        </InputContainer>

        <InputContainer>
          <img src="/src/assets/icons/icone-email.svg" alt="icone email" />
          <input type="email" id="email" required placeholder="E-mail ..." />
        </InputContainer>

        <InputContainer>
          <img src="/src/assets/icons/icone-senha.svg" alt="icone senha" />
